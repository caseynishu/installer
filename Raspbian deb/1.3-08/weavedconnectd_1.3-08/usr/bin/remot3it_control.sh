#!/bin/bash
#
#  Remot3it Control Script manages remot3it devices on a platform
#
#  remot3it_control <flags> command 
#
...
#
#
#  remot3it Inc : http://remot3it
#
#

# include shell script lib
source /usr/bin/remot3it_wlib.sh
