...
#
# This is a simple notifcation script that can send events to the 
# Weaved notification server
#
# Usage:  weavednotify.sh <type> <UID> <secret> <message string> <status string>
#
# type 0 =auth only
...
#
# Example:
# weavednotify.sh 0 00:00:48:02:2A:A0:32:2D BA4F204876384F921F714DD177CE12D360593CCD "this is a msg" "this is a status"
#
#
# Config curl path
CURL="curl"
